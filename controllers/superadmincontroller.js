...
const generateToken = (id) => {
    return jwt.sign({ id, userType: 'superadmin' }, process.env.JWT_SECRET, {
        expiresIn: "1d",
    })
};
...
exports.registerSuperadmin = async (req, res) => {
    try {
        ...
        res.status(400).json({ message: error.message || "Error registering superadmin" });
    }
}
...
exports.registerClient = async (req, res) => {
    try {
        ...
        const client = await Client.create({
            ...
            panNo,
            aadharNo,
            businessLogoKey: 'default',
            businessLogoUrl: 'default',
            mobileNo: '0000000000',
            address: 'N/A'
        });
